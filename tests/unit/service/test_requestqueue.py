...
from ignition.service.requestqueue import KafkaRequestQueueService, RequestHandler, KafkaInfrastructureConsumerFactory, KafkaLifecycleConsumerFactory
...
class TestRequestQueueService(unittest.TestCase):
    ...
    def test_requestqueue_process_request(self):
        ...
        args, kwargs = request_handler.handle.call_args
        self.assertEqual(len(args), 1)
        request = args[0]
    ...
    def test_requestqueue_process_missing_request_id(self):
        mock_kafka_lifecycle_consumer = MagicMock()
        mock_kafka_lifecycle_consumer_factory = MagicMock()
        mock_kafka_lifecycle_consumer_factory.create_consumer.return_value = mock_kafka_lifecycle_consumer
        ...
        request_handler.handle.assert_not_called()
        mock_kafka_lifecycle_consumer.commit.assert_not_called()

    def test_requestqueue_process_missing_lifecycle_name(self):
        mock_kafka_lifecycle_consumer = MagicMock()
        mock_kafka_lifecycle_consumer_factory = MagicMock()
        mock_kafka_lifecycle_consumer_factory.create_consumer.return_value = mock_kafka_lifecycle_consumer
    ...
    def test_requestqueue_process_missing_lifecycle_scripts(self):
        mock_kafka_lifecycle_consumer = MagicMock()
        mock_kafka_lifecycle_consumer_factory = MagicMock()
        mock_kafka_lifecycle_consumer_factory.create_consumer.return_value = mock_kafka_lifecycle_consumer
    ...
    def test_requestqueue_process_missing_deployment_location(self):
        mock_kafka_lifecycle_consumer = MagicMock()
        mock_kafka_lifecycle_consumer_factory = MagicMock()
        mock_kafka_lifecycle_consumer_factory.create_consumer.return_value = mock_kafka_lifecycle_consumer
