...
from ignition.service.messaging import Envelope, TopicsProperties, MessagingProperties
...
class TestMessagingJobQueueService(unittest.TestCase):
    ...
    def setUp(self):
        ...
        job_queue=JobQueueProperties()
        job_queue.create_topic = False
    ...
    def test_init_without_messaging_properties_throws_error(self):
        with self.assertRaises(ValueError) as context:
            MessagingJobQueueService(postal_service=self.mock_postal_service, inbox_service=self.mock_inbox_service, topics_config=self.mock_topics_config)
    ...
    def test_init_without_postal_service_throws_error(self):
        with self.assertRaises(ValueError) as context:
            MessagingJobQueueService(inbox_service=self.mock_inbox_service, topics_config=self.mock_topics_config, messaging_config=MessagingProperties)
    ...
    def test_init_without_inbox_service_throws_error(self):
        with self.assertRaises(ValueError) as context:
            MessagingJobQueueService(postal_service=self.mock_postal_service, topics_config=self.mock_topics_config, messaging_config=MessagingProperties)
    ...
    def test_init_without_topics_config_throws_error(self):
        with self.assertRaises(ValueError) as context:
            MessagingJobQueueService(postal_service=self.mock_postal_service, inbox_service=self.mock_inbox_service, messaging_config=MessagingProperties)
    ...
    def test_init_without_job_queue_topic_throws_error(self):
        ...
        with self.assertRaises(ValueError) as context:
            MessagingJobQueueService(postal_service=self.mock_postal_service, inbox_service=self.mock_inbox_service, topics_config=mock_topics_config, messaging_config=MessagingProperties)
    ...
    def test_init_configures_watch_on_job_queue_inbox(self):
        job_queue_service = MessagingJobQueueService(postal_service=self.mock_postal_service, inbox_service=self.mock_inbox_service, topics_config=self.mock_topics_config, messaging_config=MessagingProperties())
